...
namespace Week12Work
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("What file would you like to remove from existing ones from the fruit folder?");
            string userInput3 = Console.ReadLine();

            FileDeleteFruit(userInput3);

            Console.WriteLine("What file would you like to remove from existing ones from the Vegetable folder");
